...
if($opsi=="input") { //opsi input
	...
	$query = "INSERT INTO tb_training (outlook, temperature, humidity, windy, play) VALUES ('$outlook', '$temperature', '$humidity', '$windy', '$play')";
	...
	$query = "UPDATE tb_training SET outlook='$outlook', temperature='$temperature', humidity='$humidity', windy='$windy', play='$play' WHERE id= '$id'";
	...
	// hapus data
	$query = "DELETE FROM tb_training WHERE id = $id";
	$delete = mysqli_query($koneksi,$query);

	// panggil data id paling terakhir
	$query = "SELECT id FROM tb_training ORDER BY id DESC";
	...
	$query = "ALTER TABLE tb_training auto_increment=$ai";
